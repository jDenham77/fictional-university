...
"use strict";
__webpack_require__.r(__webpack_exports__);
// All this code is from the documentation inside Advanced Custom Fields
class GMap {
  constructor() {
...
class MyNotes {
  ...
  events() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#my-notes").on("click", ".delete-note", this.deleteNote); // $(".edit-note").on("click", this.editNote.bind(this)); this will not fire when a new note created bec it doesn't know that button exists
  ...
  makeNoteReadOnly(thisNote) {
    ...
    thisNote.find(".note-title-field, .note-body-field").attr("readonly", "readonly") // jQuery attr 2 arguments. the attribte and value
  ...
  deleteNote(e) {
    var thisNote = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li"); // We target the ancestors of the line item
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      // This is targeting the data-id global attribute
      type: 'DELETE',
      success: response => {
...
;
/* harmony default export */ __webpack_exports__["default"] = (MyNotes); // import axios from "axios"
// class MyNotes {
//   constructor() {
