    ...
    <header class="site-header">
      <div class="container">
        <h1 class="school-logo-text float-left">
          <a href="<?php echo esc_url(site_url()); ?>"><strong>Fictional</strong>
           University
          </a>
        </h1>
        ...
        <div class="site-header__menu group">
          <nav class="main-navigation">
            ...
            <!-- Navigate the theme menu via admin dashboard
              wp_nav_menu(array(
          ...
          <div class="site-header__util">
            <?php if (is_user_logged_in()) { ?>
              ...
              <a href="<?php echo wp_logout_url(); ?>" class="btn btn--small btn--dark-orange float-left btn--with-photo">
                <!-- get_avatar 2 arguments: 1. user; 2. image size in pixels -->
                <span class="site-header__avatar"><?php echo get_avatar(
                  get_current_user_id(), 60) ?></span>
